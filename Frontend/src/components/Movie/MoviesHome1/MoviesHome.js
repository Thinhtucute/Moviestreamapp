...
function MoviesHome({ movies = [], size = 'large', orientation = 'portrait', title = '' }) {
    ...
    const styles = {
        ...
        movieItem: {
            ...
            width: orientation === 'landscape' ? { xs: '240px', sm: '270px', md: '300px' } : { xs: '150px', sm: '180px', md: '200px' },
            height: orientation === 'landscape' ? { xs: '135px', sm: '152px', md: '169px' } : { xs: '225px', sm: '270px', md: '300px' },
        },
        movieInfo: {
            position: 'absolute',
            bottom: 0,
                        ...
                        <Box key={index} sx={styles.movieItem}>
                            ...
                            <Box sx={styles.movieInfo}>
                                ...
                                >
                                    ...
                                    <Box
                                        sx={{
                                            background: 'linear-gradient(135deg, rgba(249, 115, 22, 0.8), rgba(245, 158, 11, 0.6))',
                                            border: '1px solid rgba(255, 255, 255, 0.2)',
                                            borderRadius: '6px',
                                            padding: '0px 8px',
                                            backdropFilter: 'blur(8px)',
